package com.aslmmovic.qurancompanion.presentation.screens.placeholder
...
import qurancompanion.shared.generated.resources.map_explorer_title
...
fun LibraryPlaceholderScreen(
    ...
    Box(
        ...
        Column(
            ...
            Icon(
                painter = painterResource(Res.drawable.ic_tab_library),
            ...
            Text(
                text = stringResource(Res.string.tab_library),
...
fun HabitsPlaceholderScreen(
    ...
    Box(
        ...
        Column(
            ...
            Icon(
                painter = painterResource(Res.drawable.ic_tab_habits),
                contentDescription = null,
                tint = MaterialTheme.colorScheme.primary,
                modifier = Modifier.size(48.dp)
            )
            Spacer(modifier = Modifier.height(16.dp))
            Text(
                text = stringResource(Res.string.tab_habits),
                style = MaterialTheme.typography.headlineMedium,
                fontWeight = FontWeight.Bold,
                color = MaterialTheme.colorScheme.onBackground
            )
...
fun ExplorePlaceholderScreen(
    ...
    Box(
        ...
        Column(
            ...
            Icon(
                painter = painterResource(Res.drawable.ic_tab_explore),
                contentDescription = null,
                tint = MaterialTheme.colorScheme.primary,
                modifier = Modifier.size(48.dp)
            )
            ...
            Button(
                ...
                Text(
                    text = stringResource(Res.string.map_explorer_title),
...
@Composable
fun MapExplorerPlaceholderScreen(
    onNavigateBack: () -> Unit,
    modifier: Modifier = Modifier
) {
    Box(
